...
class DoctorsAdapter(
    ...
    class DoctorViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val consultationFeeTextView: TextView =
            itemView.findViewById(R.id.consultationFeeTextView)
        ...
        fun bind(doctor: Doctor, onDoctorClicked: (Doctor) -> Unit, onBookClicked: (Doctor) -> Unit) {
            ...
            consultationFeeTextView.text = doctor.consultationFee
